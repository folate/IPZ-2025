  ...
  <section class="w-full bg-gradient-to-b from-teal-50/50 to-background dark:from-teal-950/20 py-16 sm:py-24">
    <div class="container mx-auto px-4 sm:px-6 flex flex-col items-center justify-center text-center space-y-8">
      ...
      <div class="relative w-full max-w-3xl mx-auto group">
        ...
        />
        <button class="absolute right-2 top-2 bottom-2 bg-teal-600 hover:bg-teal-700 dark:bg-teal-500 dark:hover:bg-teal-600 text-white px-6 rounded-xl font-medium transition-colors shadow-sm cursor-pointer z-10">
          Szukaj
        </button>
      </div>
    </div>
